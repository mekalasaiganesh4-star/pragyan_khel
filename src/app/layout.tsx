...
export const metadata: Metadata = {
  title: 'Temporal Vision - Video Temporal Error Detector',
  description: 'Analyze and detect frame drops and merges in video streams using GenAI and temporal analysis.',
};
